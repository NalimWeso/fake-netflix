...
const episodes = [
    ...
    },
    {
        ...
        title: "3. From Scrubbing to Spinning",
    ...
    {
        id: 5,
        thumbnail: "episode-5.jpg",
        title: "5. Behind Closed Doors",
    ...
    {
        id: 6,
        thumbnail: "episode-6.jpg",
        title: "6. The Famous Spin Cycle",
...
episodes.forEach((episode) => {
    ...
    <div class="episode" id="${episode.id}">
        <div class="episode-img">
            <img src="thumbnails/${episode.thumbnail}" alt="Thumbnail" draggable=false>
